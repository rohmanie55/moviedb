...
public class Upcoming extends Base {
    ...
    private void listData() {
        ...
        Call<MyMovie> call = apiClient.getApiInterface().getMovieUpcoming(Constants.API_KEY);
        call.enqueue(new Callback<MyMovie>() {
            ...
            public void onResponse(Call<MyMovie> call, Response<MyMovie> response) {
                if (response.isSuccessful()) {
                    ...
                    updateDatabase(results, "upcoming");
                }
            }
        ...
        initDatabase();
        List<MovieList> moviedb = db.getAllMovie("upcoming");
